	...
	function Nav({ className }: { className?: string }) {
		return (
			<nav className={className}>
				<Link className={page === 'Blockchain' ? 'selected' : undefined} href="/">
					Blockchain
				</Link>
				<Link className={page === 'Alt-blocks' ? 'selected' : undefined} href="/alt-blocks">
					Alt-blocks
				</Link>
				<Link className={page === 'Aliases' ? 'selected' : undefined} href="/aliases">
					Aliases
				</Link>
				{/* {netMode === "TEST" ?
                    <Link 
				...
				<Link className={page === 'Assets' ? 'selected' : undefined} href="/assets">
					Assets
				</Link>
				<Link className={page === 'Charts' ? 'selected' : undefined} href="/charts">
					Charts
				</Link>
				<Link className={page === 'API' ? 'selected' : undefined} href="/zano_api">
					API
				</Link>
				{netMode === 'MAIN' && <p>Governance</p>}
			</nav>
		);
	}
		...
		<header className={styles.header}>
			<div className={styles.header__top}>
				<div className={styles.header__top__main}>
					<Link href="/">{netMode === 'TEST' ? <LogoImg /> : <LogoMainnetImg />}</Link>
					<Nav />
				</div>
					...
					<Link
						...
						href={
							netMode === 'TEST'
								...
								: 'https://testnet.explorer.zano.org/'
						}
						target="_blank"
						rel="noreferrer"
					>
