		...
		return (
			<div className={styles.table__pagination}>
				<div className={styles.table__pagination__pages}>
					...
					<Input type="text" value={page} onInput={(e) => onNumberInput(e, setPage)} />
				</div>
	...
	return (
		<div className={className}>
			{!isLoading ? (
				<>
					<table
						className={`${styles.table} ${!textWrap ? styles.table__text_nowrap : ''}`}
					>
						<thead>
							<tr>
								{headers.map((e) => (
									<th key={nanoid(16)}>{e}</th>
								))}
							</tr>
							{headerStatus && (
								<tr className={styles.table__info_status}>
